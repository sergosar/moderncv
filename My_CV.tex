...
\email{miroshnichenkos@gmail.com}                               % optional, remove / comment the line if not wanted

% Social icons
%l[linkedin]{sergey-malashenko}                        % optional, remove / comment the line if not wanted
%\social[telegram]{sergey\_malashenko}                            % optional, remove / comment the line if not wanted
\photo[70pt][0.4pt]{pictures/1.JPG}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
\section{Образование}
\cventry{2001--2007}{}{Саровский Физико-Технический Институт (МИФИ)}{}{\textit{GPA -- 4.7}}{}  % Arguments not required can be left empty
