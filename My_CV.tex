...
Разработка бэкэнд части микросервиса комплексной ERP системыв рамках технического задания. Локализация (руссификация) программного комплекса для снятия требуемых метрик с баз данных.
}
